...
class JITFunction(JITCallable, KernelInterface[T]):
    ...
    def run(self, dims, *args, **kwargs):
        ...
        # `_pack_args` normalizes backend options before caching.  In
        # particular, `validate_invariants` is read from the environment by
        # AMDGPU option parsing and is therefore part of the cache identity.
